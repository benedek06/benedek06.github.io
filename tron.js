...
function start() {
    ...
    var player1 = new Player(get("player1").value, 0, 0, Heading.Right, game, Fills.Blue, ["w", "d", "s", "a"])
    var player2 = new Player(get("player2").value, 49, 49, Heading.Left, game, Fills.Red)
...
function stopper(player) {
    ...
    get("state").innerHTML = player.name + " Meghalt... "
